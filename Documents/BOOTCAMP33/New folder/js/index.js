...
function createStudent() {
  ...
  */
    ...
    if(student.id.trim() === '') {
      ...
      document.querySelector('#spanMaSV').innerHTML = 'Mã sinh viên không được bỏ trống';
      valid = false;
    }
    if(student.name.trim() === '') {
      // alert('tên sinh viên không được bỏ trống !');
      document.querySelector('#spanTenSV').innerHTML = 'Tên sinh viên không được bỏ trống';
      valid = false;
    }
